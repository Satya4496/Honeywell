...
public static class IntelliFireSystemsEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE IntelliFireSystemsModuleExtensionConfigurator CLASS (in the Domain.Shared project)
