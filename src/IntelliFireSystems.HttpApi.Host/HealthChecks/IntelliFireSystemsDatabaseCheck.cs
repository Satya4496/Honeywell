...
public class IntelliFireSystemsDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public IntelliFireSystemsDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
